...
data_path_cal = os.path.join(os.getcwd(), 'data/calibration/')
...
data_cal = [x for x in data_files_cal if 'csv' in x]
...
def Dataframe(directory):
    ...
    for i in range(len(directory)):
        ...
        df1 = df1.loc[df1[file_names[i]] > 100]
...
df_cal, file_names_cal = Dataframe(data_dir_cal)
