...
Subsequently, the incoming ions were directed towards the thin target foil
...
\begin{figure}[t]
    \centering
    \includegraphics[trim={0cm, 25cm, 0cm, 40cm}, clip, width=0.99\columnwidth]{setup4}
...
\footnotetext{The estimated thickness of each target available have been
determined by the previous users of the experimental setup and written down on
the whiteboard next to the setup.} 
