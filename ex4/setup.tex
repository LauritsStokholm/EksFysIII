...
\subsection{Targets}
%\fxnote{FIX}
The targets of interest in this experiment was a thin gold coated carbon plate. The gold layer was about one tenth of the carbon thickness. The thickness of the carbon layer have previously been determined as $\approx\SI{250}{\angstrom}$, and the thickness of the gold layer as $\approx\SI{25}{\angstrom}$.\footnotemark \\
\footnotetext{The estimated thickness of each target available have been determined by the previous users of the experimental setup and written down on the whiteboard next to the setup.} 
